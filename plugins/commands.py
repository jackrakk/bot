            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        ...
                        InlineKeyboardButton('Join Channel', url='https://t.me/Raj_Files')
                    ]
                    ]
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton("Join Channel", url="https://t.me/RF_Movie")
                    ],
                    [
...
async def bot_info(bot, message):
    ...
    await message.reply(text="Language : <code>Python3</code>\nLibrary : <a href='https://docs.pyrogram.org/'>Pyrogram asyncio</a>\nSource Code : <a href='https://www.youtube.com/shorts/M8c3Qha-6Cg'>Click here</a>\nUpdate Channel : <a href='https://t.me/RFs_Movies'>Raj Files Bots</a> </b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
